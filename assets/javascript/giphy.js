$(document).ready(function () {
    ...
    // re-renders the html to display the right content
    function animalInfo() {

        var animal = $(this).attr("data-name");
        var queryURL = "https://api.giphy.com/v1/gifs/search?q=" + animal + "&api_key=8KlorxDnGq90aNmGgX8hb5tF5c5UGvig&limit=10";
        ...
        $.ajax({
            ...
            .then(function (response) {
                var aniamlDiv = $("<div class = 'animal'>");
